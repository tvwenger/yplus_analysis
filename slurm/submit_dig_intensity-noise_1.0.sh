...
#SBATCH --job-name="dig_intensity-noise_1.0"
#SBATCH --output="logs/dig_intensity-noise_1.0_logs/%x.%j.%N.out"
#SBATCH --error="logs/dig_intensity-noise_1.0_logs/%x.%j.%N.err"
...
DIR_NAME="dig_intensity-noise_1.0"
PER_JOB=113
NUM_SPEC=112540
